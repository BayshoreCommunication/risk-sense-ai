...
const testEnvironment = `NEXT_PUBLIC_ENV=ci NEXT_PUBLIC_API_URL=${baseURL}/test-api NEXT_PUBLIC_FIREBASE_API_KEY=frontend-test-key NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=auth.example.test NEXT_PUBLIC_FIREBASE_PROJECT_ID=frontend-test NEXT_PUBLIC_DEMO_ACCESS_ENABLED=true`;
