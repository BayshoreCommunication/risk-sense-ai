...
function ConditionNodeEditor({
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/70 bg-muted/20 p-4 shadow-sm" data-testid="condition-node">
...
function StringListEditor({
  ...
  return (
    <fieldset className="space-y-2 rounded-xl border border-border/70 bg-muted/15 p-4">
...
function FlowEditor({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  ...
  return (
    <div className="space-y-2" data-testid="structured-flow">
      {flow.length === 0 ? <p className="rounded-xl border border-dashed border-border/80 bg-muted/15 p-4 text-xs text-muted-foreground">{t('empty')}</p> : null}
      {flow.map((node, index) => (
        <fieldset key={`flow-${index}`} className="space-y-3 rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm">
  ...
  return (
    <div className="grid gap-3" data-testid="structured-actions">
      {CLASSIFICATIONS.map((classification) => {
        ...
        return (
          <fieldset key={classification} className="space-y-3 rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm">
...
function OptionsEditor({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  ...
  return (
    <div className="space-y-2" data-testid="structured-options">
      {options.length === 0 ? <p className="rounded-xl border border-dashed border-border/80 bg-muted/15 p-4 text-xs text-muted-foreground">{t('empty')}</p> : null}
      {options.map((option, index) => (
        <fieldset key={`option-${index}`} className="space-y-3 rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm">
...
function BranchEditor({ value, onChange }: { value: string; onChange: (value: string) => void }) {
  ...
  if (!branch) {
    return (
      <div className="rounded-xl border border-dashed border-border/80 bg-muted/15 p-4" data-testid="structured-branch">
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm" data-testid="structured-branch">
  ...
  return (
    <div className="space-y-3" data-testid="structured-factors">
      ...
      {FACTOR_KEYS.map((key) => {
        ...
        return (
          <fieldset key={key} className="space-y-4 rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm">
  ...
  return (
    <div className="grid gap-2 sm:grid-cols-2" data-testid="structured-thresholds">
      {CLASSIFICATIONS.map((classification) => {
        ...
        return (
          <fieldset key={classification} className="rounded-xl border border-border/70 bg-muted/15 p-4 shadow-sm">
            <legend className="px-1.5 text-xs font-semibold text-foreground">{t(`classification.${classification}`)}</legend>
